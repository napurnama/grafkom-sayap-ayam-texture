...
//prepare bumpMap
const bump_texture = new THREE.TextureLoader().load('./textures/emit-texture.jpeg');
...
createPointLight(0, -10, 3);
createPointLight(0, 10, 3);

// mapDemo(0, 0, 0);
// emissiveMapDemo(0, 0, 0);
// alphaMapDemo(0, 0, 0);
// bumpMapDemo(0, 0, 0);
// displacementMapDemo(0,0,0);
// multiMapDemo(0,0,0);
// UVMapDemo(5, -2.5, -2.5);
